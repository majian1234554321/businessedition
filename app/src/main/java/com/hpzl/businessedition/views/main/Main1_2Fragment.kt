...
import kotlinx.android.synthetic.main.main1_2fragment.*
 ...
 * @date 2018/1/30
 */
class Main1_2Fragment : BaseFragment(), Main1_1234View, XRecyclerView.LoadingListener {
    ...
    private val TYPE: String = "5"
    var page = 0
    lateinit var main1_1234Present: Main1_1234Present

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return View.inflate(inflater.context, R.layout.main1_2fragment, null)
    }
